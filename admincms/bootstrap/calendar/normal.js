...
var gcCalBG="#7589C1";	// the background color of the outer calendar panel.
...
var gsBottom="<A href='void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Today : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcSatBG="#D8DEEB";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#ADBAD6";	// Sunday background color
