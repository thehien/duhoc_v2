<?php /* Smarty version 2.6.13, created on 2018-02-03 08:49:21
         compiled from translater/views.html */ ?>
...
" height="50"/>
          ...
          <?php endif; ?>
           ...
           <td align="left" class="mw_150">
            <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['address']; ?>
" value="<?php echo $this->_tpl_vars['rs']['address']; ?>
" style="font-weight:bold" />
          ...
          <td valign="center" class="mw_100">
           <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['longitude']; ?>
" value="<?php echo $this->_tpl_vars['rs']['longitude']; ?>
" />
          </td>

         
          <td valign="center" class="mw_150">
           <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['latitude']; ?>
" value="<?php echo $this->_tpl_vars['rs']['latitude']; ?>
" />
          </td>

           <td valign="center" class="mw_200">
            
             <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['content']; ?>
" value="<?php echo $this->_tpl_vars['rs']['content']; ?>
" />
          </td>
