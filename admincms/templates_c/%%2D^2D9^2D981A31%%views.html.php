<?php /* Smarty version 2.6.13, created on 2018-03-20 05:36:37
         compiled from language/views.html */ ?>
...
&order=news_name&sc=desc"><i class="fa fa-caret-down"></i></a>
          ...
          <td align="center">Ngôn ngữ nguồn
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
...
" style="font-weight:bold" />
          ...
          <td valign="center" class="mw_200">
           <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['from_language_name']; ?>
" value="<?php echo $this->_tpl_vars['rs']['from_language_name']; ?>
" />
          </td>

         
          <td valign="center" class="mw_200">
           <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['to_language_name']; ?>
" value="<?php echo $this->_tpl_vars['rs']['to_language_name']; ?>
" />
          </td>
