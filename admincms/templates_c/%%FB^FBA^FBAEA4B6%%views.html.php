<?php /* Smarty version 2.6.13, created on 2018-12-25 16:52:28
         compiled from trans_order/views.html */ ?>
              ...
              <table class="table_insert">
                <thead>
                 <tr>
                   ...
                   <td>
                    <select disabled="" class="select_option" name="coupon_status" id="coupon_status" style="font-weight:bold" >
...
&order=id_tem&sc=desc"><i class="fa fa-caret-down"></i></a>
                  ...
                  <td class="mw_200">Translater Info</td>
...
" class="status_edit">
                    ...
                    <td valign="top" style="line-height:22px; width: 200px;">
                      <i class="name_orders" >Translater Name :</i> <br/><strong> <?php echo $this->_tpl_vars['rs']['trans_name']; ?>
</strong><br />
                      <i class="name_orders" >Translater Email :</i> <br/> <strong> <?php echo $this->_tpl_vars['rs']['trans_email']; ?>
</strong><br />
                      <i class="name_orders" >Project ID :</i> <strong> <?php echo $this->_tpl_vars['rs']['coupon_code']; ?>
</strong><br />
                      <i class="name_orders">Subject Field :</i> <i><?php echo $this->_tpl_vars['rs']['subject_field']; ?>
</i><br />
...
" class="orders_edit"/><br />
                     ...
                     <i class="name_orders">Total (55 %) :</i> <input type="text" name="" value="$ <?php echo $this->_tpl_vars['rs']['percent']; ?>
" class="orders_edit"/><br />
