<?php /* Smarty version 2.6.13, created on 2018-09-14 04:19:56
         compiled from list_language/insert.html */ ?>
                        ...
                        <td>
                            <div class="col-lg-12">
                                <table class="table_insert" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <td align="right" class="mmw_250"><span><?php echo @langcms_language; ?>
 <em>*</em></span></td>
                                            <td style="width: 300px;"><input type="text" class="check_input" placeholder="<?php echo @langcms_language; ?>
...
" />
                               ...
                               <tr>
                                    ...
                                    <?php if ($this->_tpl_vars['rs_edit']['img_flag']): ?>
                                    <div style="float:left">
                                    <input type="hidden" name="image_old" id="image_old" value="<?php echo $this->_tpl_vars['rs_edit']['img_flag']; ?>
" />
        
                                    <img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs_edit']['img_flag']; ?>
