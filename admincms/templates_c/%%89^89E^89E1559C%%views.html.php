<?php /* Smarty version 2.6.13, created on 2018-09-14 09:26:06
         compiled from special/views.html */ ?>
...
&order=id_tem&sc=desc"><i class="fa fa-caret-down"></i></a>
          ...
          <td><?php echo @langcms_chuyennganh; ?>
...
&order=news_name&sc=desc"><i class="fa fa-caret-down"></i></a>
         ...
         <td>Alias link industry
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=url&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=url&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>
         ...
         <td>Images
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=img&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=img&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>
         ...
         <td>Icon
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=icon&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=icon&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>
...
" style="font-weight:bold" />
           ...
           <td valign="center" align="center" class="mw_300">
            <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['category_url']; ?>
" value="<?php echo $this->_tpl_vars['rs']['category_url']; ?>
" />
          </a>
          </td>

          <td valign="center" align="center" class="mw_300">
           <?php if ($this->_tpl_vars['rs']['img']): ?>
              <img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs']['img']; ?>
" height="32"/>
            <?php else: ?>
          ...
          <td valign="center" align="center" class="mw_300">
           <?php if ($this->_tpl_vars['rs']['icon']): ?>
              <img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs']['icon']; ?>
" height="32"/>
            <?php else: ?>
              <i class="fa fa-picture-o status_img"></i>
           <?php endif; ?>
