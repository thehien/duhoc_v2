<?php /* Smarty version 2.6.13, created on 2018-05-14 04:41:17
         compiled from software/insert.html */ ?>
                        ...
                        <td>
                            <div class="col-lg-12">
                                <table class="table_insert" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <td align="right" class="mmw_250"><span><?php echo @langcms_software; ?>
 <em>*</em></span></td>
                                            <td style="width: 300px;"><input type="text" class="check_input" placeholder="<?php echo @langcms_software; ?>
