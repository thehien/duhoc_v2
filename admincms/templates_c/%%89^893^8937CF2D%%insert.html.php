<?php /* Smarty version 2.6.13, created on 2019-08-11 10:54:05
         compiled from translator_service/insert.html */ ?>
                                ...
                                <table class="table_insert" style="width: 100%;">
                                    ...
                                    <tr>
                                        <td align="right" class="mmw_250">
                                            <span><?php echo @langcms_service; ?>
 <em>*</em></span></td>
                                        <td style="width: 300px;"><input type="text" class="check_input"
                                                                         placeholder="<?php echo @langcms_service; ?>
"
                                                                         name="service_name" id="service_name" value="<?php echo $this->_tpl_vars['rs_edit']['service_name']; ?>
"/>
                                        </td>

                                        <td align="right" class="mmw_250"><span>Code <em>*</em></span></td>
                                        <td style="width: 300px;">
                                            <input type="text" class="check_input" placeholder="Code" name="service_code"
                                                   id="service_code" value="<?php echo $this->_tpl_vars['rs_edit']['service_code']; ?>
"/>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:40%"><input class="check_url" type="text" name="service_url"
                                                                     id="service_url" value="<?php echo $this->_tpl_vars['rs_edit']['service_url']; ?>
"
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top"><input type="file" name="filename" id="filename" class="border_solid"
                                                                value=""/>
                                            <?php if ($this->_tpl_vars['rs_edit']['service_img']): ?>
                                            <div style="float:left">
                                                <input type="hidden" name="image_old" id="image_old"
                                                       value="<?php echo $this->_tpl_vars['rs_edit']['service_img']; ?>
"/>
                                                <img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs_edit']['service_img']; ?>
" height="50"
