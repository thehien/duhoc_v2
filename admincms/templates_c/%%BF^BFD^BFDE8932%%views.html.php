<?php /* Smarty version 2.6.13, created on 2017-11-10 00:28:29
         compiled from products/views.html */ ?>
...
" >
    ...
    <td width="20"></td>
    <td width="90">Search code</td>
    <td><div class="input-group custom-search-form">
           
            <input type="text" class="form-control" placeholder="Search..." name="code_search" id="code_search" value="<?php echo $this->_tpl_vars['code_search']; ?>
" >
            <span class="input-group-btn">
            <button class="btn btn-default" type="submit" name="submit" id="submit">
                <i class="fa fa-search"></i>
...
&limit=1000" <?php if ($this->_tpl_vars['limit'] == 1000): ?>selected="selected"<?php endif; ?>>1000</option>
        ...
        <li>
           <select class="cate_option" onchange="MM_jumpMenu('parent',this,0)" >
                <option value="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_order'];  echo $this->_tpl_vars['url_limit']; ?>
...
&order=news_code&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_code&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>
...
&order=news_level&sc=desc"><i class="fa fa-caret-down"></i></a>
          ...
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_salary&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_salary&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>
           <td align="center">Work At
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_work_at&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_work_at&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>

          <td align="center">Job type
          <div class="order">
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=job_type&sc=asc"><i class="fa fa-caret-up"></i></a>  
              <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=job_type&sc=desc"><i class="fa fa-caret-down"></i></a>
          </div>
          </td>
...
?>
          ...
          <?php echo $this->_tpl_vars['rs']['news_code']; ?>
          ...
          <a href="<?php echo @URL_HOMEPAGE;  echo $this->_tpl_vars['rs']['id_tem']; ?>
-<?php echo $this->_tpl_vars['rs']['news_url']; ?>
.html" target="_blank" class="status_views">
          <i class="fa fa-hand-o-right"></i>
          <?php if ($this->_tpl_vars['rs']['news_img']): ?>
          <br /><img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs']['img_file']; ?>
/<?php echo $this->_tpl_vars['rs']['news_img']; ?>
" width="100" />
          <?php else: ?>
          <br /><i class="fa fa-picture-o status_img"></i>
          <?php endif; ?>
          </a>
          </td>
          
          <td valign="center" class="mw_250">
          <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
" value="<?php echo $this->_tpl_vars['rs']['news_name']; ?>
" style="font-weight:bold" /><br />
          <i class="name_i"><?php echo @langcms_danhmuc; ?>
</i>:
          <a href="<?php echo @URL_HOMEPAGE;  echo $this->_tpl_vars['rs']['news_urlcate'];  echo $this->_tpl_vars['rs']['category_url']; ?>
.html" target="_blank"><?php echo $this->_tpl_vars['rs']['category_name']; ?>
</a><br />
          
          </td>

          <td valign="center" class="mw_100">
          <?php echo $this->_tpl_vars['rs']['news_level']; ?>
 
          </td>

          <td valign="center" class="mw_100">
          <?php echo $this->_tpl_vars['rs']['news_salary']; ?>
 
          </td>

          <td valign="center" class="mw_100">
          <?php echo $this->_tpl_vars['rs']['news_work_at']; ?>

          </td>

           <td valign="center" class="mw_100">
          <?php if ($this->_tpl_vars['rs']['job_type'] == 0): ?>
            <span style="color:#ff8c00;">Part-time</span>
          <?php else: ?>
            <span style="color:#007bff;font-weight: bold;">Full-time</span>
          <?php endif; ?>
          </td>
...
"  
            <?php if ($this->_tpl_vars['rs']['status'] == 1): ?>class="status_on"<?php else: ?>class="status_off"<?php endif; ?>><i class="fa fa-check-square"></i>
              ...
              <tr><td><span style="font-weight: bold;">Hot job:</span></td>
              <td><a href="<?php echo @URL_ADMIN; ?>
?module=<?php echo $this->_tpl_vars['url']; ?>
&main=home&id=<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
&home=<?php echo $this->_tpl_vars['rs']['home']; ?>
" <?php if ($this->_tpl_vars['rs']['home'] == 1): ?>class="status_on"<?php else: ?>class="status_off"<?php endif; ?>><i class="fa fa-check-square"></i>
            </a>
            <?php if ($this->_tpl_vars['rs']['home'] == 1): ?>
            <input type="hidden" name="home<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
" value="0" />
            <?php else: ?>
            <input type="hidden" name="home<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
" value="1" />
...
" class="status_edit">
          ...
          <a href="<?php echo @URL_ADMIN; ?>
?module=<?php echo $this->_tpl_vars['url']; ?>
&main=copys<?php echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops']; ?>
&id_edit=<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
" class="status_copy"><i class="fa fa-share"></i> Copy </a><br />
          </td>
          <?php endif; ?>
