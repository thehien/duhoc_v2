<?php /* Smarty version 2.6.13, created on 2019-06-08 11:53:57
         compiled from translator_service/views.html */ ?>
...
.html" target="_blank"
                                ...
                                <td align="center" class="mw_50">
                                    <?php if ($this->_tpl_vars['rs']['service_img']): ?>
                                    <img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs']['service_img']; ?>
" height="35"/>
                                    <?php else: ?>
                                ...
                                <td valign="center" class="mw_300">
                                    <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['service_name']; ?>
" value="<?php echo $this->_tpl_vars['rs']['service_name']; ?>
"
                                ...
                                <td valign="center" class="mw_300">
                                    <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['service_code']; ?>
" value="<?php echo $this->_tpl_vars['rs']['service_code']; ?>
"/>
                                </td>
