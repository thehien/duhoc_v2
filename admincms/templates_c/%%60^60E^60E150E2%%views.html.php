<?php /* Smarty version 2.6.13, created on 2019-08-11 11:15:03
         compiled from news_category/views.html */ ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group custom-search-form">
                                ...
                                <input type="text" class="form-control" placeholder="Search..." name="name_search"
                                       id="name_search" value="<?php echo $this->_tpl_vars['name_search']; ?>
">
...
&order=news_name&sc=desc"><i
                                ...
                                <td align="center">Code
                                    <div class="order">
                                        <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_level&sc=asc"><i
                                                class="fa fa-caret-up"></i></a>
                                        <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=news_level&sc=desc"><i
                                                class="fa fa-caret-down"></i></a>
                                    </div>
                                </td>
                                ...
                                <td align="center"><?php echo @langcms_trangthai; ?>
                                    ...
                                    <div class="order">
                                        <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=status&sc=asc"><i
                                                class="fa fa-caret-up"></i></a>
                                        <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_category'];  echo $this->_tpl_vars['url_shops'];  echo $this->_tpl_vars['url_limit']; ?>
&order=status&sc=desc"><i
                                                class="fa fa-caret-down"></i></a>
                                    </div>
                                </td>
                                <?php if ($this->_tpl_vars['action_edit']): ?>
...
?>
                            <tr>
                                ...
                                <td align="center" class="mw_80">
                                    <a href="<?php echo @URL_HOMEPAGE;  echo $this->_tpl_vars['rs']['category_id']; ?>
-<?php echo $this->_tpl_vars['rs']['category_url']; ?>
.html" target="_blank"
                                       class="status_views">
                                        <?php echo $this->_tpl_vars['rs']['category_id']; ?>

                                    </a>
                                </td>

                                <td align="center" class="mw_50">
                                    <?php if ($this->_tpl_vars['rs']['category_img']): ?>
                                    <img src="<?php echo @IMG_UPLOAD;  echo $this->_tpl_vars['url']; ?>
/<?php echo $this->_tpl_vars['rs']['category_img']; ?>
" height="35"/>
                                    <?php else: ?>
                                ...
                                <td valign="center" class="mw_300">
                                    <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['category_name']; ?>
" value="<?php echo $this->_tpl_vars['rs']['category_name']; ?>
"
                                ...
                                <td valign="center" class="mw_300">
                                    <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['category_code']; ?>
" value="<?php echo $this->_tpl_vars['rs']['category_code']; ?>
"/>
                                </td>
...
&id_edit=<?php echo $this->_tpl_vars['rs']['category_id']; ?>
"
                                       class="status_edit">
...
&main=updategiam">
            ...
            <a href="<?php echo @URL_ADMIN; ?>
?module=categorys"><i class="fa fa-hand-o-right"></i>
                <?php echo @langcms_xemtl; ?>
</a>
        </div>
        <?php endif; ?>
    </div>
