<?php /* Smarty version 2.6.13, created on 2018-08-26 10:38:28
         compiled from language/insert.html */ ?>
                        ...
                        <td>
                            <div class="col-lg-12">
                                <table class="table_insert" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <td align="right" class="mmw_250"><span>Cặp ngôn ngữ <em>*</em></span></td>
                                            <td style="width: 300px;"><input type="text" class="check_input" placeholder="Cặp ngôn ngữ" name="name" id="name" value="<?php echo $this->_tpl_vars['rs_edit']['name']; ?>
" /></td>

                                            <td align="right" class="mmw_250"><span>Giá tiền / 1 từ <em>*</em></span></td>
                                            <td style="width: 300px;">
                                               <input type="text" class="check_input" placeholder="Giá tiền / 1 từ" name="price" id="price" value="<?php echo $this->_tpl_vars['rs_edit']['price']; ?>
" />
                                           </td>

                                       </tr>
                                       <tr>
                                           <td align="right" class="mmw_200"><span>Ngôn ngữ nguồn <em>*</em></span></td>
                                           <td style="width: 300px;">
                                              <select class="select_option check_input" name="from_language" id="from_language" >
                                                <option value="">Select Language</option>
                                                <?php $_from = $this->_tpl_vars['rs_language']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['val'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['val']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['val']):
        $this->_foreach['val']['iteration']++;
?>
                                                <option value="<?php echo $this->_tpl_vars['val']['id']; ?>
" <?php if ($this->_tpl_vars['val']['id'] == $this->_tpl_vars['rs_edit']['from_language']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['val']['name']; ?>
</option>
                                                <?php endforeach; endif; unset($_from); ?>
                                            </select>
                                        </td> 

                                        <td align="right" class="mmw_250"><span>Ngôn ngữ đích <em>*</em></span></td>
                                        <td style="width: 300px;">
                                          <select class="select_option check_input" name="to_language" id="to_language" >
                                            <option value="">Select Language</option>
                                            <?php $_from = $this->_tpl_vars['rs_language']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['val'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['val']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['val']):
...
?>
                                            <option value="<?php echo $this->_tpl_vars['val']['id']; ?>
" <?php if ($this->_tpl_vars['val']['id'] == $this->_tpl_vars['rs_edit']['to_language']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['val']['name']; ?>
</option>
                                            <?php endforeach; endif; unset($_from); ?>
                                        </select>
                                    </td>
