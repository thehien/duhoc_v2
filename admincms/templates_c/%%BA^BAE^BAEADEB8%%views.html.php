<?php /* Smarty version 2.6.13, created on 2018-10-21 10:30:20
         compiled from users/views.html */ ?>
...
" /></td>
            ...
            <tr>
            <td align="right"><?php echo @langcms_phanquyen; ?>
</td>
            <td>
                <select name="user_role" id="user_role" class="user_role select_option">   
                     <option value="1" <?php if ($this->_tpl_vars['rs_edit']['user_role'] == 1): ?>selected<?php endif; ?>>Admin</option>	 
                     <option value="2" <?php if ($this->_tpl_vars['rs_edit']['user_role'] == 2): ?>selected<?php endif; ?>>Staff</option>
                     <option value="3" <?php if ($this->_tpl_vars['rs_edit']['user_role'] == 3): ?>selected<?php endif; ?>>Shop</option>	  	
                     <option value="4" <?php if ($this->_tpl_vars['rs_edit']['user_role'] == 41): ?>selected<?php endif; ?>>User</option>	
                 </select>
            </td>
            </tr>
            <tr>
...
&order=firstname&sc=desc"><i class="fa fa-caret-down"></i></a>
          ...
          <?php if ($this->_tpl_vars['action_edit']): ?><td align="center"><?php echo @langcms_capquyen; ?>
</td><?php endif; ?>
...
" />
          ...
          <td>
             <?php if ($this->_tpl_vars['rs']['user_role'] == 1): ?>
               Admin
             <?php elseif ($this->_tpl_vars['rs']['user_role'] == 2): ?>   
               Staff
             <?php elseif ($this->_tpl_vars['rs']['user_role'] == 3): ?>
               Shop
             <?php elseif ($this->_tpl_vars['rs']['user_role'] == 4): ?>
               User
             <?php endif; ?>
          </td>
...
" class="status_edit"><i class="fa fa-pencil-square-o"></i></a>
          ...
          <td align="center">
             <?php if ($this->_tpl_vars['rs']['user_role'] == 1): ?>
               <a href="<?php echo @URL_ADMIN; ?>
?module=<?php echo $this->_tpl_vars['url']; ?>
&main=action_role&id=<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
" class="status_edit"><i class="fa fa-users"></i> </a>
             <?php endif; ?>   
          </td>
          <?php endif; ?>
