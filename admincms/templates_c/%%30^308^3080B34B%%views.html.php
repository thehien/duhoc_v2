<?php /* Smarty version 2.6.13, created on 2017-11-10 00:28:51
         compiled from jobseekers/views.html */ ?>
...
?>
          ...
          <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['news_code']; ?>
" value="<?php echo $this->_tpl_vars['rs']['news_code']; ?>
" />
          </td>
...
.html" target="_blank" class="status_views">
          ID: <?php echo $this->_tpl_vars['rs']['id_tem']; ?>
 
          <br />
          <?php if ($this->_tpl_vars['rs']['cv_file']): ?>
           Attach CV : <i class="fa fa-download"></i>
          <?php endif; ?>
...
" height="50"/>
          ...
          <?php endif; ?>
           ...
           <td align="left" class="mw_200">
            <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['news_title']; ?>
" value="<?php echo $this->_tpl_vars['rs']['news_title']; ?>
" style="font-weight:bold" />
           </td>

           <td valign="center" class="mw_200">
          <?php echo $this->_tpl_vars['rs']['news_name']; ?>

          </td>


          <td valign="center" class="mw_100">
          <?php echo $this->_tpl_vars['rs']['news_language']; ?>
 
          </td>

         
          <td valign="center" class="mw_150">
           <input type="text" name="news_name<?php echo $this->_tpl_vars['rs']['id_tem']; ?>
" value="<?php echo $this->_tpl_vars['rs']['news_location']; ?>
" />
          </td>

           <td valign="center" class="mw_100">
          <?php echo $this->_tpl_vars['rs']['news_visa']; ?>
