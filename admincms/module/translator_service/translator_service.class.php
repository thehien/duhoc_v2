...
class Translator_service_class
{

    function Translator_service_class() { }
...
//Views
    function num_views($name_search, $category, $shops)
    {
        ...
        $sql = "SELECT a.id FROM list_cate_study_abroad a
    ...
    FROM list_cate_study_abroad t1
    where t1.id >= 1
...
//category parent all
    ...
    function insert_table($data)
    {
        ...
        $sql = "INSERT INTO list_cate_study_abroad (
			    service_name,service_img,service_url,service_content,service_code,status,language,create_dated)
				VALUES('" . $data['service_name'] . "','" . $data['service_img'] . "','" . $data['service_url'] . "'
				,'" . $data['service_content'] . "','" . $data['service_code'] . "','" . $data['status'] . "',  '" . $data['language'] . "','$created_date')";
        //echo $sql;exit;
        $res = $db->db_query($sql);
        $db->db_freeresult($res);
        return false;
...
//Edit
    function get_id($id)
    {
        ...
        $sql = "Select a.*, a.id as id_tem from list_cate_study_abroad a
...
//delete
    ...
    function delete_table($id)
    {
        global $db;
        $id = intval($id);
        $sql = "Delete from list_cate_study_abroad where id='$id'";
        $db->db_query($sql);
        return false;
    }
...
//Status
    function status_table($id, $status)
    {
        ...
        $sql = "Update list_cate_study_abroad set status ='$status' where id = $id $sr_shop";
        $res = $db->db_query($sql);
        $db->db_freeresult($res);
        return 1;
    }
    ...
    function status_off_table($id)
    {
        ...
        $sql = "Update list_cate_study_abroad set status ='0' where id='$id' $sr_shop";
        $db->db_query($sql);
        return false;
    }
    ...
    function status_on_table($id)
    {
        ...
        $sql = "Update list_cate_study_abroad set status ='1' where id='$id' $sr_shop";
        $db->db_query($sql);
        return false;
    }
