<?php
require("module/translator_service/translator_service.class.php");

function translator_service_process()
{
    ...
    $Process = new Translator_service_class();
    ...
    switch ($main) {
        ...
        case "insert":
            ...
            if ($submit) {
                $data['info']['service_name'] = $function->sql_injection(isset($_POST['service_name']) ? $_POST['service_name'] : "");

                if ($_POST['service_url']) {
                    $data['info']['service_url'] = $function->character_url(isset($_POST['service_url']) ? $_POST['service_url'] : "");
                } else {
                    $data['info']['service_url'] = $function->character_url(isset($_POST['name']) ? $_POST['name'] : "");
                }

                $data['info']['service_content'] = $function->FixQuotes(isset($_POST['service_content']) ? $_POST['service_content'] : "");

                $data['info']['service_code'] = $function->sql_injection(isset($_POST['service_code']) ? $_POST['service_code'] : "");
                ...
                if ($file_size > 2097152) {
                    ...
                    $data['info']['service_img'] = $name_image;
                } else {
