<?php
require("module/translater/translater.class.php");

function translater_process() {
  ...
  switch ($main) {
    ...
    case "insert":
      ...
      if ($submit) {
        ...
        if ($_POST['url']) {
          $data['info']['url'] = $function->character_url(isset($_POST['url']) ? $_POST['url'] : "");
        } else {
          $data['info']['url'] = $function->character_url(isset($_POST['name']) ? $_POST['name'] : "");
        }
        $data['info']['address'] = $function->character_url(isset($_POST['address']) ? $_POST['address'] : "");

        $data['info']['longitude'] = $function->FixQuotes(isset($_POST['longitude']) ? $_POST['longitude'] : "");
        $data['info']['latitude'] = $function->FixQuotes(isset($_POST['latitude']) ? $_POST['latitude'] : "");
        $data['info']['email'] = $function->FixQuotes(isset($_POST['email']) ? $_POST['email'] : "");
        ...
        $data['info']['content'] = $function->FixQuotes(isset($_POST['content']) ? $_POST['content'] : "");
         ...
         $data['info']['fromlanguage'] = $function->FixQuotes(isset($_POST['fromlanguage']) ? $_POST['fromlanguage'] : "");

          $data['info']['tolanguage'] = $function->FixQuotes(isset($_POST['tolanguage']) ? $_POST['tolanguage'] : "");
        
        $data['info']['language']    = 1;
...
// 					} else {										
    ...
    case "general":
      ...
      //Bo loc san pham
      $rs_filter = $Process->show_filter_Jobseekers($id_edit);
