<?php
require("module/news_category/news_category.class.php");

function news_category_process()
{
    ...
    $Process = new News_category_class();
    ...
    switch ($main) {
        ...
        case "insert":
            ...
            if ($submit) {
                ...
                $data['info']['category_content'] = $function->FixQuotes(isset($_POST['category_content']) ? $_POST['category_content'] : "");

                $data['info']['category_code'] = $function->sql_injection(isset($_POST['category_code']) ? $_POST['category_code'] : "");
