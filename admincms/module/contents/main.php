...
function contents_process()
{
    ...
    $tree_select = $class_cate->get_list_news_category_arrays(0);
    $smarty->assign('tree_select', $tree_select);

    $study_select = $class_cate->get_list_study_arrays(0);
    $smarty->assign('study_select', $study_select);
    ...
    switch ($main) {
        ...
        case "insert":
            ...
            if ($submit) {
                ...
                $data['info']['study_category'] = $function->sql_injection(isset($_POST['study_category']) ? intval($_POST['study_category']) : 0);
