<?php
require("module/duhoc_program_cate/duhoc_program_cate.class.php");

function duhoc_program_cate_process()
{
    ...
    $Process = new Duhoc_program_cate_class();
    ...
    $tree_select = $class_cate->select_duhoc_program_arrays(0);
