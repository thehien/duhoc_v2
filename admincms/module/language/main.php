<?php
require("module/language/language.class.php");
  ...
  switch ($main) {
    ...
    case "insert":
      ...
      if ($submit) {
        ...
        $data['info']['from_language'] = $function->sql_injection(isset($_POST['from_language']) ? intval($_POST['from_language']) : 0);
        $data['info']['to_language'] = $function->sql_injection(isset($_POST['to_language']) ? intval($_POST['to_language']) : 0);
        ...
        //Price
        $data['info']['price'] = $function->sql_injection(isset($_POST['price']) ? $_POST['price'] : 0);
