...
//Views
  function num_views($name_search, $category, $shops) {
    ...
    $sql = "SELECT a.id FROM coupons_language a
...
//Insert
  function insert_table($data) {
    global $db;
    $created_date = time();
    $sql = "INSERT INTO coupons_language (
			    id,name,from_language,to_language,price,language,status,created_date)
				VALUES(NULL,'" . $data['name'] . "','" . $data['from_language'] . "','" . $data['to_language'] . "','" . $data['price'] . "',	'" . $data['language'] . "',  '" . $data['status'] . "','$created_date')";
    //echo $sql;exit;
    $res = $db->db_query($sql);
    $db->db_freeresult($res);
    return false;
...
//Edit
  function get_id($id)
  {
    ...
    $sql = "Select a.*, a.id as id_tem from coupons_language a
  ...
  function edit_table($id, $data){
    ...
    $sql = "Update coupons_language set name ='" . $data['name'] . "', from_language ='" . $data['from_language'] . "',to_language ='" . $data['to_language'] . "',price ='" . $data['price'] . "',status ='" . $data['status'] . "' where id='$id' ";
