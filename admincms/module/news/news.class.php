...
//Views
    ...
    function views_table($page, $per_page, $order, $sc, $name_search, $category)
    {
        ...
        $sql = "SELECT a.news_id as id_tem,a.news_name,a.status,a.news_img,a.news_url,a.pos, b.service_name,b.service_url as news_urlcate
		FROM coupons_news a, list_cate_study_abroad b where a.news_id >= '1' and a.news_category = b.id 
