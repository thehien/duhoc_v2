...
//Insert
    function insert_table($data)
    {
        ...
        $sql = "INSERT INTO coupons_special_category (
			    id,category_name,language,status,created_date)
				VALUES(NULL,'" . $data['category_name'] . "',	'" . $data['language'] . "',  '" . $data['status'] . "','$created_date')";
...
//Edit
    ...
    function edit_table($id, $data)
    {
        ...
        $sql = "Update coupons_special_category set category_name ='" . $data['category_name'] . "',status ='" . $data['status'] . "' where id='$id' ";
