...
//Views
  function num_views($name_search, $category, $shops) {
    ...
    $sql = "SELECT a.id FROM list_software a
...
//Edit
  function get_id($id)
  {
    global $db;
    $sr_shop = '';
    $sql = "Select a.*, a.id as id_tem from list_software a
  ...
  function edit_table($id, $data){
    ...
    $sql = "Update list_software set name ='" . $data['name'] . "',code ='" . $data['code'] . "',status ='" . $data['status'] . "' where id='$id' ";
...
//delete
  ...
  function delete_table($id)
  {
    global $db;
    $id = intval($id);
    $sql = "Delete from list_software where id='$id'";
    $db->db_query($sql);
    return false;
  }
...
//Status
  function status_table($id, $status)
  {
    ...
    $sql = "Update list_software set status ='$status' where id = $id $sr_shop";
    $res = $db->db_query($sql);
    $db->db_freeresult($res);
    return 1;
  }
  ...
  function status_off_table($id)
  {
    ...
    $sql = "Update list_software set status ='0' where id='$id' $sr_shop";
    $db->db_query($sql);
    return false;
  }
  ...
  function status_on_table($id)
  {
    ...
    $sql = "Update list_software set status ='1' where id='$id' $sr_shop";
    $db->db_query($sql);
    return false;
  }
