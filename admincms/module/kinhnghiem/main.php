<?php
require("module/kinhnghiem/kinhnghiem.class.php");

function kinhnghiem_process() {
  ...
  switch ($main) {
    ...
    case "insert":
      ...
      if ($submit) {
        $data['info']['name'] = isset($_POST['name']) ? $_POST['name'] : "";
