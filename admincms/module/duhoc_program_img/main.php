<?php
require("module/duhoc_program_img/duhoc_program_img.class.php");

function duhoc_program_img_process()
{
    ...
    $Process = new Duhoc_program_img_class();
    ...
    $tree_select = $class_cate->select_list_program_arrays(0);
