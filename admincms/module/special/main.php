<?php
require("module/special/special.class.php");
    ...
    switch ($main) {
        ...
        case "insert":
            ...
            if ($submit) {
                ...
                $data['info']['category_detail'] = $function->sql_injection(isset($_POST['category_detail']) ? $_POST['category_detail'] : "");
                ...
                $type_name1 = $_FILES['filename1']['type'];
                $new_name1 = $_FILES['filename1']['name'];
                ...
                if ($file_size1 > 2097152) {
                    ...
                    $data['info']['icon'] = $name_image1;
                } else {
                    $data['info']['icon'] = '';
                }
                // end image

                //$function->debugPrint($data['info']);
                ...
                if ($data['info']['category_name'] == "") {
                    ...
                    if ($id_edit) {
                        ...
                        $image_old1 = $function->FixQuotes(isset($_POST['image_old1']) ? $_POST['image_old1'] : "");
                        $delete_img1 = $function->FixQuotes(isset($_POST['delete_img1']) ? intval($_POST['delete_img1']) : 0);
                        if ($new_name) {
                            if ($image_old) {
