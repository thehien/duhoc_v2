<?php
require("module/scholarship/scholarship.class.php");

function scholarship_process()
{
    ...
    switch ($main) {
        ...
        case "insert":
            ...
            if ($submit) {
                ...
                $data['info']['news_type'] = $function->sql_injection(isset($_POST['news_type']) ? $_POST['news_type'] : "");
