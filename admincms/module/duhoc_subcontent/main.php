<?php
require("module/duhoc_subcontent/duhoc_subcontent.class.php");

function duhoc_subcontent_process()
{
    ...
    $Process = new Duhoc_subcontent_class();
    ...
    $sub_category = $class_cate->get_list_sub_duhoc_arrays(0);
    $smarty->assign('sub_category', $sub_category);
    ...
    switch ($main) {
        ...
        case "insert":
            ...
            if ($submit) {
                ...
                $data['info']['news_type_category'] = $function->sql_injection(isset($_POST['news_type_category']) ? intval($_POST['news_type_category']) : 0);
