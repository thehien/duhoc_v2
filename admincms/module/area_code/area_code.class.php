<?php
class Area_code_class {
  
  function Area_code_class() {}
...
//Views
  function num_views($name_search, $category, $shops) {
    ...
    $sql = "SELECT a.id FROM list_area_code a
...
//Insert
  function insert_table($data) {
   ...
   $created_date = date('y/m/d h:i:s', time());
    $sql = "INSERT INTO list_area_code (
			    id,name,code,language,status,create_dated)
				VALUES(NULL,'" . $data['name'] . "','" . $data['code'] . "','" . $data['language'] . "',  '" . $data['status'] . "','$created_date')";
    //echo $sql;exit;
    $res = $db->db_query($sql);
    $db->db_freeresult($res);
    return false;
...
//Edit
  function get_id($id)
  {
    ...
    $sql = "Select a.*, a.id as id_tem from list_area_code a
  ...
  function edit_table($id, $data){
    ...
    $sql = "Update list_area_code set name ='" . $data['name'] . "', code ='" . $data['code'] . "',status ='" . $data['status'] . "' where id='$id' ";
...
//delete
  ...
  function delete_table($id)
  {
    global $db;
    $id = intval($id);
    $sql = "Delete from list_area_code where id='$id'";
    $db->db_query($sql);
    return false;
  }
